...
public static class Constantes
{
    ...
    public static readonly List<string> animales = new List<string> { "aguila", "ballena", "burro", "caballo", "cabra", "cerdo", "cocodrilo", "delfin", "elefante", "gallina", "gallo", "gato", "gaviota", "leon", "lobo", "loro", "mono", "oso", "oveja", "paloma", "perro", "pollo", "rana", "ratón", "serpiente", "tigre", "vaca"};
